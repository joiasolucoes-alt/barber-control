  ...
  ({ side = 'right', className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ref={ref}
        className={cn(sheetVariants({ side }), 'flex flex-col overflow-y-auto p-5 sm:p-6', className)}
        {...props}
      >
        {children}
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn('heading-display text-lg font-semibold', className)} {...props} />
))
